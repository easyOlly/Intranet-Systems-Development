		...
		Time is:&nbsp;<input type="submit" class="trans" name="face" value="">
                        ...
                        ?>
								...
								<ul class="nav nav-tabs nav-stacked">
									<li class="active">
										<a href="director.php"><i class="icon-home icon-large"></i>&nbsp;Home<i class="icon-arrow-right icon-large"></i></a>
									</li>
									
							
                                	<li><a href="members.php"><i class="icon-group icon-large"></i>&nbsp;Story Seeker<i class="icon-arrow-right icon-large"></i></a></li>
									
									<li><a href="district.php"><i class="icon-group icon-large"></i>&nbsp;Story<i class="icon-arrow-right icon-large"></i></a></li>
