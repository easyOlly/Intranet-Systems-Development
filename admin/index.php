		...
		<div class="container">
			<div id="top-links">
				<ul class="list-inline pull-left button">
					...
					<li>
						<a href="../index.php"><span>Click to Back </span></a>
					</li>
					<li>
			...
			<div class="row">
				...
				<div class="col-sm-3 col-md-3 col-xs-12 visible-xs paddleft">
					...
					<div class="button-login pull-right">
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='login.html'">Student Login</button>
						<button type="button" class="btn btn-primary btn-lg" onclick="location.href='register.html'"> Student Registration</button>
					</div>
...
$result=mysqli_query($conn,"select * from users where username='$username' and password='$password'")or die (mysql_error());//query sang database 
